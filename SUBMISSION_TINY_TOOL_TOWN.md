# Tiny Tool Town Submission Draft

Use this content in the Tiny Tool Town issue template:
...
- Website or Demo URL (optional):
	- (leave blank or add a short demo video URL)
- Your Name:
	- David Rowley
- Your GitHub Username:
	- davidrrowley
- Tags:
	- windows, monitor, screen-mirroring, tray, desktop-utility, cplusplus
...
- Utility-focused:
	- windows, desktop, monitor, mirroring, tray, cplusplus
- Playful-focused:
	- windows, tiny, fun, second-screen, tray, cplusplus

## Final Checklist Before Submit

- Ensure README top section reflects current features.
- Add one screenshot or short GIF near the top of README.
- Confirm repo is public and builds on Windows.
- Confirm submission checkboxes:
